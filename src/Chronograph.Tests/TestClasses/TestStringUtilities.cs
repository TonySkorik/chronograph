...
public class TestStringUtilities
{
	...
	{
		var testString = """
		querying 200 similar data points '{"must":[{"key":"ship_to_list","match":{"any":["RU"]}},{"key":"segment_ids","match":{"any":["17647"]}}]}'
		""";

		var escaped = testString.EscapeCurlyBraces();

		escaped.Should().Be("querying 200 similar data points '{{\"must\":[{{\"key\":\"ship_to_list\",\"match\":{{\"any\":[\"RU\"]}}}},{{\"key\":\"segment_ids\",\"match\":{{\"any\":[\"17647\"]}}}}]}}'");
	}
}